...
# -*- coding: utf-8 -*-
"""
sphinx-xelatex unit test driver
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

This script runs the sphinx-xelatex unit test suite.
...
print('Running sphinx-xelatex test suite (with Python %s)...' % sys.version.split()[0])
sys.stdout.flush()
